...
urlpatterns = [
    ...
    path('subscriptions/<int:author_id>', api.follow_delete, name='follow_delete'),
    path('follow/', views.follow, name='follow'),
    path('favorites', api.favorite_add, name='favorite_add'),
    path('favorites/<int:recipe_id>', api.favorite_delete, name='favorite_delete'),
    path('favorite/', views.favorite, name='favorite'),
    path('purchases', api.shopping_list_add, name='shopping_list_add'),
    path('purchases/<int:recipe_id>', api.shopping_list_delete, name='shopping_list_delete'),
    path('shopping_list/', views.shopping_list, name='shopping_list'),
    path('shopping_list/download/', views.shopping_list_download, name='shopping_list_download'),
